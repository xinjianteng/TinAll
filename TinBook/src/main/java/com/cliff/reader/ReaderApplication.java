...
import com.cliff.reader.base.CrashHandler;
import com.cliff.reader.component.AppComponent;
import com.cliff.reader.component.DaggerAppComponent;
import com.cliff.reader.module.AppModule;
import com.cliff.reader.module.BookApiModule;
...
//        initHciCloud();
    ...
    protected void initHciCloud() {
        ...
        initparam.addParam(InitParam.AuthParam.PARAM_KEY_DEVELOPER_KEY, "7e1550fa2d751a6d5da839470007b126");
        initparam.addParam(InitParam.AuthParam.PARAM_KEY_APP_KEY, "d45d548a");

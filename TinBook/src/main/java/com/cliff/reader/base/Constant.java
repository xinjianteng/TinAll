...
public class Constant {
    ...
    public static final String API_BASE_URL = "http://app.geeboo.com/";

    public static final String API_BASE_PARAMS = (new BaseReq()).toString();

    public static final String IMG_BASE_URL = API_BASE_URL+"system/getRes.go"+"?id=";

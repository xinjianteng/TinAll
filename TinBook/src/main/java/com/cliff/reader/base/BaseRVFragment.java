...
import com.cliff.reader.view.recyclerview.adapter.OnLoadMoreListener;
import com.cliff.reader.view.recyclerview.adapter.RecyclerArrayAdapter;
import com.cliff.reader.view.recyclerview.swipe.OnRefreshListener;
 ...
 * @date 16/9/3.
 */
public abstract class BaseRVFragment<T1 extends BaseContract.BasePresenter, T2>
        extends BaseFragment
        implements OnLoadMoreListener, OnRefreshListener, RecyclerArrayAdapter.OnItemClickListener {

...
import com.cliff.reader.view.recyclerview.EasyRecyclerView;
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (CollectionsManager.getInstance().add(books)) {
                            ...
                            if (books.path.endsWith(Constant.SUFFIX_TXT)) {
                                // TXT
//                                ReadActivity.startActivity(ScanLocalBookActivity.this, books, books.isFromSD);
                            } else if (books.path.endsWith(Constant.SUFFIX_PDF)) {
                                // PDF
                                ReadPDFActivity.start(ScanLocalBookActivity.this, books.path);

...
import com.cliff.reader.view.easyadapter.abslistview.EasyLVAdapter;
import com.cliff.reader.view.easyadapter.abslistview.EasyLVHolder;
...
public class ReadThemeAdapter extends EasyLVAdapter<ReadTheme> {
    ...
    public void convert(EasyLVHolder holder, int position, ReadTheme readTheme) {
        if (readTheme != null) {
            ReadThemeManager.getInstance().setReaderTheme(readTheme.theme, holder.getView(R.id.ivThemeBg));

...
import com.cliff.reader.utils.RxUtil;
...
public class SearchPresenter extends RxPresenter<SearchContract.View> implements SearchContract.Presenter<SearchContract.View> {
    ...
    public void getHotWordList(int nowPage,int onePageCount) {
        String key = StringUtils.creatAcacheKey("hot-word-list");
        Observable<HotWord> fromNetWork = bookApi.getHotWord(nowPage,onePageCount).compose(RxUtil.<HotWord>rxCacheListHelper(key));

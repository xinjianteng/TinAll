...
import com.cliff.reader.base.BaseRVActivity;
...
import com.cliff.reader.manager.cache.SearchHistoryCacheManager;
import com.cliff.reader.ui.adapter.AutoCompleteAdapter;
import com.cliff.reader.ui.adapter.SearchHistoryAdapter;
import com.cliff.reader.ui.contract.SearchContract;
import com.cliff.reader.ui.easyadapter.SearchAdapter;
import com.cliff.reader.ui.presenter.SearchPresenter;
import com.cliff.reader.view.TagColor;
import com.cliff.reader.view.TagGroup;
...
public class SearchActivity extends BaseRVActivity<SearchDetail.SearchBooks> implements SearchContract.View {
    ...
    private void saveSearchHistory(String query) {
        List<String> list = SearchHistoryCacheManager.getInstance().getSearchHistory();
        if (list == null) {
            list = new ArrayList<>();
            list.add(query);
        } else {
        ...
        SearchHistoryCacheManager.getInstance().saveSearchHistory(list);
        initSearchHistory();
    }
...
//        BookDetailActivity.startActivity(this, data._id);
    ...
    public void clearSearchHistory() {
        SearchHistoryCacheManager.getInstance().saveSearchHistory(null);
        initSearchHistory();
    }
